...
<body>
  ...
  <h2>Medidas de Tendencia Central en hombres</h2>
  ...
  <script>
    ...
    var valores = [4,3,5,3,1,3,2,1,3,3];
...
$texto = "Media: El promedio de hombres que asistieron a la biblioteca fue de: 2.8 que se aproxima a 3 hombres por día.
Mediana: En la primera mitad de los datos el valor más alto es 3 y en el resto el valor mas bajo es de 3 hombres.
Moda: El número de hombres más frecuente en los datos recolectados es de 3.";
